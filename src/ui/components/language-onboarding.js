...
export function renderLanguageOnboarding(state){
  ...
  return `<div class="modal-backdrop" id="language-modal" role="dialog" aria-modal="true" aria-labelledby="language-modal-title"><div class="modal-card">
    <div class="modal-header"><div><p class="eyebrow">ADD LANGUAGE</p><h2 id="language-modal-title">${t("add_language_title")}</h2></div><button class="icon-button" id="close-language-modal" aria-label="${t("cancel")}">×</button></div>
